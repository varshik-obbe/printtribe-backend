...
export const add_Products = async (req, res, err) => {
        ...
        try {
            ...
            const categories = new Products({
                ...
                handling_gst: data.handling_gst,
                weight: data.weight,
                AOP: data.AOP,
                        ...
                        .then((resultProducts) => {
                            const responseProducts = {
                                subProducts: resultProducts.map((subproductsData) => ({
                                    ...
                                    design_gst: subproductsData.design_gst,
                                    handling_gst: subproductsData.handling_gst,
                                    quantities_updated: subproductsData.quantities_updated,
                                    weight: subproductsData.weight,
                                    AOP: subproductsData.AOP,
                                ...
                                .then((resultsubsubProducts) => {
                                    const responseSubSubProducts = {
                                        subSubProducts: resultsubsubProducts.map((subsubProductsData) => ({
                                            ...
                                            design_gst: subsubProductsData.design_gst,
                                            handling_gst: subsubProductsData.handling_gst,
                                            quantities_updated: subsubProductsData.quantities_updated,
                                            weight: subsubProductsData.weight,
                                            AOP: subsubProductsData.AOP,
    ...
    then(async (productdata)=>{
        const response = {
            ...
            productdata:productdata.map((productrecord)=>({
                ...
                design_gst: productrecord.design_gst,
                handling_gst: productrecord.handling_gst,
                quantities_updated: productrecord.quantities_updated,
                position: productrecord.position,
                AOP: productrecord.AOP,
